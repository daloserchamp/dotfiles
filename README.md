...
My dwm config:
![dwm](https://github.com/daloserchamp/dotfiles/blob/main/gitassets/dwm.png "")

my older Qtile config:
![qtile](https://github.com/daloserchamp/dotfiles/blob/main/gitassets/Qtile.png "")
